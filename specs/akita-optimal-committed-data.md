...
> dimension-rent analysis and the flavor bench remain valid background;
> the union-vs-grouped accounting and the committed-symbols Phase-0 plan
> should be re-evaluated against the new baseline before any further
> protocol work.
