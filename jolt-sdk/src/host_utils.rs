...
pub use jolt_core::zkvm::{
    bytecode::PreprocessingError, program::FullProgramPreprocessing, program::ProgramPreprocessing,
    proof_serialization::JoltProof, verifier::JoltSharedPreprocessing,
    verifier::JoltVerifierPreprocessing, Curve, RV64IMACProof, RV64IMACVerifier, Serializable, F,
    PCS,
};
pub use jolt_core::AdviceTape;

// Re-exports needed by the provable macro
pub use jolt_core::poly::commitment::commitment_scheme::{CommitmentContext, CommitmentScheme};
