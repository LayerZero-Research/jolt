...
pub use common::{
    ...
    rv_trace::{MemoryConfig, MemoryLayout, MemoryOp, RV32IM, RVTraceRow, ELFInstruction, RegisterState, MemoryState},
};
...
pub use jolt_core::jolt::vm::{
    ...
    Jolt, JoltCommitments, JoltProof, JoltProverPreprocessing, JoltVerifierPreprocessing, JoltTraceStep
};
pub use tracer;
