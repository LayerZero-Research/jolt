...
use super::and::AND;
use super::amoswapw::{amo_pre, amo_post};
...
use super::{
    ...
    RISCVInstruction, RISCVTrace, RAMAtomic, RV32IMCycle,
};
...
impl AMOANDW {
    fn exec(&self, cpu: &mut Cpu, ram_access: &mut <AMOANDW as RISCVInstruction>::RAMAccess) {
        let address = cpu.x[self.operands.rs1] as u64;
        let and_value = cpu.x[self.operands.rs2] as u32;
